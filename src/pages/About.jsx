    ...
    return (
        <>
            ...
            <link
                ...
                href="https://gtltowers.in/wp-json/wp/v2/pages/18"
            />
            <link
                rel="EditURI"
            ...
            <link rel="canonical" href="https://gtltowers.in/about/" />
            <link rel="shortlink" href="https://gtltowers.in/?p=18" />
            <link
                rel="alternate"
                title="oEmbed (JSON)"
                type="application/json+oembed"
                href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fabout%2F"
            />
            <link
                rel="alternate"
                title="oEmbed (XML)"
                type="text/xml+oembed"
                href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fabout%2F&format=xml"
            />
            <link
                rel="modulepreload"
                    ...
                    <div className="entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained">
                        ...
                        >
                            <h2 className="wp-block-heading has-text-align-center has-large-font-size">
                                Professional Services for Communication Towers
                            </h2>
                            <p className="has-text-align-center" style={{ marginTop: 16 }}>
                                At GTL Towers, our mission is to deliver reliable and efficient
                                communication tower solutions. We are committed to supporting
                                connectivity by providing expert installation, maintenance, and
                                repair services, driven by a vision of seamless communication for
                                all.
                            </p>
                            <figure className="wp-block-image">
                                <img
                                    decoding="async"
                                    src="https://atwtowersolutions.online/assets/img/vd1ss.jpg"
                                    alt=""
                                />
                            </figure>
                            <h3 className="wp-block-heading">WHY CHOOSE OUR SERVICE</h3>
                            <p>
                            ...
                            <p>
                                Our goal is to ensure that every Indian citizen has access to strong
                                signal and decent connectivity. We think that “Digital India” will
                                only materialize until there are enough cell towers installed
                                throughout the country.
                            </p>
                            <h4 className="wp-block-heading">Tower Consulting</h4>
                            <p>
                                The technicians and operators who work with radio frequency
                                equipment, particularly base station antennas located on towers and
                                other outside places.
                            </p>
                            <h4 className="wp-block-heading">Application For Space</h4>
                            <p>
                                The installation of mobile phone towers atop buildings poses a clear
                                risk to public health. Experts claim that the radiation from
                                long-term mobile phone use is greater than those.
                            </p>
                            <style
                                dangerouslySetInnerHTML={{
                                    __html:
                            ...
                            >
                                ...
                                />
                                {/* <input type="hidden" name="currentdate" value="September 12, 2025, 6:47 pm"> */}
                                <input
                                    type="hidden"
                                    name="currentdate"
                                    defaultValue="September 13, 2025, 12:17 am"
                                />
                                ...
                                <input
                                    ...
                                    defaultValue="Sat Sep 13 2025 00:17:56 GMT+0530 (India Standard Time)"
                                />
                                <input
                                    type="hidden"
                                    id="vfm-nonce"
                            ...
                            />
                            <h2 className="wp-block-heading">Clients</h2>
                            <p>They trusted us..</p>
                            <figure className="wp-block-image aligncenter size-large is-style-default">
                                <img
                                    fetchpriority="high"
                                    decoding="async"
                                    width={1440}
                        ...
                        >
                            <div className="wp-block-group alignwide has-global-padding is-content-justification-center is-layout-constrained wp-block-group-is-layout-constrained">
                                <h2 className="wp-block-heading has-text-align-center has-large-font-size">
                                    Building Connections with Expert Tower Solutions
                                </h2>
                                <p className="has-text-align-center" style={{ marginTop: 16 }}>
                                    Hear from our satisfied clients about how GTL Towers exceeded
                                    their expectations.
                                </p>
                            </div>
                            <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-28f84493 wp-block-columns-is-layout-flex">
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        >
                                            The GTL Towers team made the entire process seamless and
                                            stress-free!
                                        </p>
                                        <div className="wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-3b4e9d3e wp-block-group-is-layout-flex">
                                            <figure className="wp-block-image aligncenter is-style-rounded">
                                                <img
                                                    ...
                                                    width={64}
                                                    height={64}
                                                    src="http://gtltowers.in/wp-content/uploads/2025/02/53ae4fa5fb3dff0a42931a299d4ef29d1634d968.jpg"
                                                    alt=""
                                                    className="wp-image-39"
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        >
                                            GTL Towers delivered outstanding results with unmatched
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        >
                                            I’m beyond impressed with the quality and service provided by
                                            GTL Towers!
                                        </p>
                                        <div className="wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-3b4e9d3e wp-block-group-is-layout-flex">
                                            <figure className="wp-block-image aligncenter is-style-rounded">
                                                <img
                                                    ...
                                                    width={64}
                                                    height={64}
                                                    src="http://gtltowers.in/wp-content/uploads/2025/02/0a49eda1a672a16a081a8c48174d1c1d0b0a03cd.jpg"
                                                    alt=""
                                                    className="wp-image-41"
                                                    style={{ aspectRatio: 1, objectFit: "cover" }}
                                                />
                                            </figure>
                                            <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
