    ...
    return (
        <>
            ...
            <link
                ...
                href="https://gtltowers.in/wp-json/wp/v2/pages/21"
            />
            <link
                rel="EditURI"
            ...
            <link rel="canonical" href="https://gtltowers.in/portfolio/" />
            <link rel="shortlink" href="https://gtltowers.in/?p=21" />
            <link
                rel="alternate"
                title="oEmbed (JSON)"
                type="application/json+oembed"
                href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fportfolio%2F"
            />
            <link
                rel="alternate"
                title="oEmbed (XML)"
                type="text/xml+oembed"
                href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fportfolio%2F&format=xml"
            />
            <link
                rel="modulepreload"
            ...
            <div className="wp-site-blocks">
                ...
                >
                    <div className="entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained">
                        ...
                        >
                            <div
                                className="wp-block-group alignwide is-vertical is-layout-flex wp-container-core-group-is-layout-c509e09b wp-block-group-is-layout-flex"
                            ...
                            >
                                <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                                    <h2 className="wp-block-heading has-large-font-size">
                                        Expert Maintenance for Communication Infrastructure
                                    </h2>
                                    <p style={{ marginTop: 16 }}>
                                        Explore standout projects that demonstrate precision,
                                        innovation, and the trusted expertise we bring to every job.
                                    </p>
                                </div>
                            </div>
                            <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-28f84493 wp-block-columns-is-layout-flex">
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    <div
                                        className="wp-block-cover has-custom-content-position is-position-bottom-center"
                                        style={{
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            width={620}
                                            height={464}
                                            className="wp-block-cover__image-background wp-image-60"
                                            alt=""
                                        ...
                                        <div className="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
                                            <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                                                <h4
                                                    className="wp-block-heading has-white-color has-text-color has-small-font-size"
                                                    style={{
                                                        marginTop: 24,
                                                        fontStyle: "normal",
                                                        fontWeight: 400
                                                ...
                                                >
                                                    Urban Tower Installation
                                                </h4>
                                                <h3
                                                    className="wp-block-heading has-white-color has-text-color has-medium-font-size"
                                                    style={{ marginTop: 12 }}
                                                >
                                                    City Center Build
                                                </h3>
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            width={1440}
                                            height={960}
                                            className="wp-block-cover__image-background wp-image-32"
                                            alt=""
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            alt=""
                                            src="http://gtltowers.in/wp-content/uploads/2025/02/076692c991847187eb2098ae902ffe6ef2f37698.jpg"
                                            data-object-fit="cover"
                                            srcSet="https://gtltowers.in/wp-content/uploads/2025/02/076692c991847187eb2098ae902ffe6ef2f37698.jpg 960w, https://gtltowers.in/wp-content/uploads/2025/02/076692c991847187eb2098ae902ffe6ef2f37698-200x300.jpg 200w, https://gtltowers.in/wp-content/uploads/2025/02/076692c991847187eb2098ae902ffe6ef2f37698-683x1024.jpg 683w, https://gtltowers.in/wp-content/uploads/2025/02/076692c991847187eb2098ae902ffe6ef2f37698-768x1152.jpg 768w"
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            width={1080}
                                            height={1440}
                                            className="wp-block-cover__image-background wp-image-43"
                                            alt=""
                                            src="http://gtltowers.in/wp-content/uploads/2025/02/bc58e705ae921ec5a6f77cd27ad0a70feedfb77a.jpg"
                                            data-object-fit="cover"
                                            srcSet="https://gtltowers.in/wp-content/uploads/2025/02/bc58e705ae921ec5a6f77cd27ad0a70feedfb77a.jpg 1080w, https://gtltowers.in/wp-content/uploads/2025/02/bc58e705ae921ec5a6f77cd27ad0a70feedfb77a-225x300.jpg 225w, https://gtltowers.in/wp-content/uploads/2025/02/bc58e705ae921ec5a6f77cd27ad0a70feedfb77a-768x1024.jpg 768w"
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            width={960}
                                            height={1440}
                                            className="wp-block-cover__image-background wp-image-51"
                                            alt=""
                                ...
                                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            width={1440}
                                            height={960}
                                            className="wp-block-cover__image-background wp-image-52"
                                            alt=""
                        ...
                        >
                            <div className="wp-block-group alignwide is-vertical is-layout-flex wp-container-core-group-is-layout-fe9cc265 wp-block-group-is-layout-flex">
                                <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                                    ...
                                    <p style={{ marginTop: 16 }}>
                                        Explore key accomplishments and performance metrics that define
                                        our success.
                                    </p>
                                </div>
                            </div>
                            <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-87beb0d0 wp-block-columns-is-layout-flex">
                                <div className="wp-block-column has-secondary-background-color has-background is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        <h3 className="wp-block-heading has-primary-color has-text-color has-x-large-font-size">
                                            120
                                        </h3>
                                        <h3
                                            className="wp-block-heading has-medium-font-size"
                                            style={{ marginTop: 16 }}
                                        >
                                            Towers Installed
                                        </h3>
                                        <p className="has-small-font-size" style={{ marginTop: 8 }}>
                                            Successfully installed over 120 communication towers across
                                            various terrains.
                                        </p>
                                    </div>
                                </div>
                                <div className="wp-block-column has-secondary-background-color has-background is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <p className="has-small-font-size" style={{ marginTop: 8 }}>
                                            Dedicated over 6,000 hours to expert tower maintenance and
                                            service.
                                        </p>
                                    </div>
                                </div>
                                <div className="wp-block-column has-secondary-background-color has-background is-layout-flow wp-block-column-is-layout-flow">
                                    ...
                                    >
                                        ...
                                        <p className="has-small-font-size" style={{ marginTop: 8 }}>
                                            Handled 450 repair projects, ensuring reliable and efficient
                                            tower performance.
                                        </p>
                                    </div>
                                </div>
                        ...
                        >
                            <div className="wp-block-columns alignwide are-vertically-aligned-center is-layout-flex wp-container-core-columns-is-layout-08c01c1c wp-block-columns-is-layout-flex">
                                <div
                                    ...
                                    <div className="wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-3b4e9d3e wp-block-group-is-layout-flex">
                                        <figure className="wp-block-image aligncenter is-style-rounded">
                                            <img
                                                ...
                                                width={94}
                                                height={94}
                                                src="http://gtltowers.in/wp-content/uploads/2025/02/3a5c5fbef6e833d0ea22e367654e02cf9fe310fd.jpg"
                                                alt=""
                                        ...
                                        <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                                            <h4
                                                ...
                                                style={{
                                                    marginTop: 18,
                                                    fontSize:
                                                        "clamp(14px, 0.875rem + ((1vw - 3.2px) * 0.417), 18px)"
                                                }}
                                            >
                                                Network Solutions Inc.
                                            </h4>
                                            <p className="has-small-font-size" style={{ marginTop: 4 }}>
                                                Project Manager
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <p
                                        style={{
                                            fontSize:
                                                "clamp(15.747px, 0.984rem + ((1vw - 3.2px) * 0.86), 24px)",
                                            fontStyle: "normal",
                                            fontWeight: 500,
                                            lineHeight: "1.5"
                                        }}
                                    >
                                        The team at GTL Towers made our 5G tower installation seamless
                                        and stress-free.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="chaty-i-trigger csaas-widget-trigger single-channel">
                            ...
                            >
                                <Link
                                    ...
                                    aria-label="Whatsapp"
                                    className="chaty-tooltip Whatsapp-channel chaty-link chaty-whatsapp-channel pos-left has-on-hover"
