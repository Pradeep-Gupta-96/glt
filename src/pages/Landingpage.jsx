                ...
                <div className="wp-block-columns alignfull is-layout-flex wp-container-core-columns-is-layout-28232c24 wp-block-columns-is-layout-flex">
                  <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-container-core-column-is-layout-8a368f38 wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      <p>
                        <strong>
                          Bettter mobile tower installation experience with GTL
                          Tower Solutions
                        </strong>
                      </p>
                      <p
                        ...
                        style={{ marginTop: 16 }}
                      >
                        Specializing in seamless communication tower services,
                        we deliver innovative solutions to meet your 4G and 5G
              ...
              >
                <div className="wp-block-group alignwide is-vertical is-layout-flex wp-container-core-group-is-layout-fe9cc265 wp-block-group-is-layout-flex">
                  ...
                  >
                    ...
                    telecommunications networks, we are the top tower
                    installation company. We have experience and are performing
                    well in business. Our goal is to ensure that every Indian
                    citizen has access to strong signal and decent connectivity.
                    We think that “Digital India” will only materialize until
                    there are enough cell towers installed throughout the
                    country.
                  </p>
                </div>
                <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-28f84493 wp-block-columns-is-layout-flex">
                  ...
                  >
                    ...
                    <p className="has-small-font-size" style={{ marginTop: 8 }}>
                      The technicians and operators who work with radio
                      frequency equipment, particularly base station antennas
                      located on towers and other outside places.
                    </p>
                  </div>
                  <div
                    className="wp-block-column has-background-background-color has-background is-layout-flow wp-block-column-is-layout-flow"
                  ...
                  >
                    ...
                    <p className="has-small-font-size" style={{ marginTop: 8 }}>
                      The installation of mobile phone towers atop buildings
                      poses a clear risk to public health. Experts claim that
                      the radiation from long-term mobile phone use is greater
                      than those.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="wp-block-group alignwide has-global-padding is-content-justification-center is-layout-constrained wp-block-group-is-layout-constrained">
                  ...
                  <p
                    ...
                    style={{ marginTop: 16 }}
                  >
                    Our clients trust us to deliver seamless tower solutions,
                    and their testimonials speak volumes about our dedication.
                  </p>
                </div>
                <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-28f84493 wp-block-columns-is-layout-flex">
                  <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      >
                        The team at GTL Towers made the entire process smooth
                  ...
                  <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      >
                        GTL Towers exceeded all expectations with their
                        precision and professionalism. Outstanding work!
                      </p>
                  ...
                  <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      >
                        I was thoroughly impressed with the level of expertise
                        and exceptional service provided by GTL Towers.
                      </p>
                      <figure className="wp-block-image size-large">
                        <img
                          loading="lazy"
                ...
                <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-is-layout-28f84493 wp-block-columns-is-layout-flex">
                  <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      >
                        I was pleased with ATW Tower Solutions Service’s
                        flawless tower installation. Excellent network coverage
                        was made possible by their knowledge and attention to
                        detail.
                      </p>
                      <figure className="wp-block-image size-full">
                        <img
                  ...
                  <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                    ...
                    >
                      ...
                      >
                        ...
                        Service’s tower installation. They were to be commended
                        for their professionalism and respect to the rules.
                      </p>
                      <figure className="wp-block-image size-large">
                        <img
                          loading="lazy"
            ...
            {step === 1 && (
              <>
                ...
                <input
                  type="text"
                  name="pattaOrSurvey"
                  placeholder="Enter Patta / Survey"
                  value={formData.pattaOrSurvey}
                  onChange={handleChange}
                  style={inputStyle}
                />
                <button
