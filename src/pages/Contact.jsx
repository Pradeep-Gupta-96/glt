...
const Contact = () => {
  return (
    <>
      ...
      />
      <title>Apply Now – GTL Towers</title>
      <link
        rel="alternate"
      ...
      <link
        ...
        href="https://gtltowers.in/wp-json/wp/v2/pages/19"
      />
      <link
        rel="EditURI"
      ...
      <link rel="canonical" href="https://gtltowers.in/contact/" />
      <link rel="shortlink" href="https://gtltowers.in/?p=19" />
      <link
        rel="alternate"
        title="oEmbed (JSON)"
        type="application/json+oembed"
        href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fcontact%2F"
      />
      <link
        rel="alternate"
        title="oEmbed (XML)"
        type="text/xml+oembed"
        href="https://gtltowers.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgtltowers.in%2Fcontact%2F&format=xml"
      />
      <link
        rel="modulepreload"
            ...
            >
              ...
              >
                ...
                <input
                  type="hidden"
                  name="ip"
                  defaultValue="2401:4900:a063:ea9f:7c62:7a23:f1ee:3239"
                />
                <input
                  type="hidden"
                  name="browser"
                ...
                />
                {/* <input type="hidden" name="currentdate" value="September 14, 2025, 5:37 am"> */}
                <input
                  type="hidden"
                  name="currentdate"
                  defaultValue="September 14, 2025, 11:07 am"
                />
                ...
                <input
                  ...
                  defaultValue="Sun Sep 14 2025 11:07:17 GMT+0530 (India Standard Time)"
                />
                <input
                  type="hidden"
                  id="vfm-nonce"
            ...
            >
              <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                <h2 className="wp-block-heading has-text-align-center has-large-font-size">
                  Expert Communication Tower Services
                </h2>
                <p className="has-text-align-center" style={{ marginTop: 16 }}>
                  Ready to enhance your connectivity? Call us today for expert
                  solutions tailored to your communication tower needs.
                </p>
                <div className="wp-block-buttons is-content-justification-center is-layout-flex wp-container-core-buttons-is-layout-720bcce9 wp-block-buttons-is-layout-flex">
                  <div className="wp-block-button is-style-outline is-style-outline--2">
                    <Link
              ...
              <div
                style={{ aspectRatio: "16/9", minHeight: "unset" }}
                className="wp-block-cover alignwide has-aspect-ratio"
              >
                <img
                  fetchpriority="high"
                  decoding="async"
